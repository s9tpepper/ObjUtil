...
//
// MODIFIED BY: OMAR GONZALEZ :: omar@almerblank.com
// ObjUtil is a modified version of mx.utils.ObjectUtil, modified to work in
// projects that are AS3 only.  ObjUtil will not work with IList objects or
// with any ObjectProxy objects.  I've only tested ObjUtil.toString()
//
////////////////////////////////////////////////////////////////////////////////

package almerblank.flash.utils
{
...
public class ObjUtil
{
    ...
    */
    ...
    public static function toString(value:Object, 
									maximumLevelOfRecursions:Number = 3,
                                    ...
                                    exclude:Array = null):String
    {
        ...
        refCount = 0;
        return "\n" + internalToString(value, 0, null, namespaceURIs, exclude, maximumLevelOfRecursions);
    }
    ...
    private static function internalToString(value:Object, 
                                             ...
                                             namespaceURIs:Array = null, 
                                             exclude:Array = null,
											 maximumLevelOfRecursions:Number = 3):String
    {
        var str:String;
        ...
        switch (type)
        {
            ...
            case "object":
            {
                ...
                else
                {
					...
					if (indent < (maximumLevelOfRecursions*2 + 2))
					{
	                    ...
	                    for (var j:int = 0; j < properties.length; j++)
	                    {
	                        ...
	                        try
	                        {
	                            str += internalToString(
	                                        ...
	                                        exclude, maximumLevelOfRecursions);
	                        }
	                        catch(e:Error)
	                        {
					...
					{
						str = "MAXIMUM RECURSION LEVELS REACHED: " + ((indent - 2)/2).toString();
					}
                    indent -= 2;
                    return str;
                }
        ...
        if (typeOfA == typeOfB)
        {
            switch(typeOfA)
            {
                ...
                case "object":
                {
					...
					// REMOVED FOR COMPATIBILITY WITH AS3 ONLY PROJECTS :: OMAR GONZALEZ
    ...
    */
    ...
    {   
		...
		// REMOVED FOR COMPATIBILITY FOR USE IN FLASH AS3 PROJECTS :: OMAR GONZALEZ
        ...
        else
        {
            ...
            ////trace( 'describeType(obj).typeDescription = ' + describeType(obj).typeDescription );
